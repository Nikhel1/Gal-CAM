...
def run(args):
    ...
    train_dataset = mscoco.dataloader.COCOClassificationDataset(
        ...
        resize_long=(340, 340), hor_flip=True, crop_size=210, crop_method="random", random_rotate=True) #resize_long=(320, 640) crop_size=512
    ...
    torch.save(model.module.state_dict(), args.cam_weights_name_last)
