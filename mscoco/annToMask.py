...
if __name__ == '__main__':
    ...
    annFile = '../RadioGalaxyNET_V3edge/annotations/instances_train2017.json'
    mask_path = '../RadioGalaxyNET_V3edge/mask/train2017'
    ...
    annFile = '../RadioGalaxyNET_V3edge/annotations/instances_val2017.json'
    mask_path = '../RadioGalaxyNET_V3edge/mask/val2017'
    os.makedirs(mask_path, exist_ok=True)
    coco = COCO(annFile)
    ids = list(coco.imgs.keys())
    print(len(ids))
